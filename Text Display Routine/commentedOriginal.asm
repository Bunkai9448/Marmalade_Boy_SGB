...
.open "output.gb", 0
    ...
    add  a, b           ; ROM0:0000 - Add register B to A
    ld   b, b           ; ROM0:0001 - Load B into B (effectively a NOP)
    jr   nz, 0x0014     ; ROM0:0002 - Jump to 0x0014 if zero flag not set
    ld   (0x0204), sp   ; ROM0:0004 - Store stack pointer at 0x0204
    ld   bc, 0x6F85     ; ROM0:0007 - Load BC with immediate value 0x6F85
    ld   a, 0x00        ; ROM0:000A - Load A with immediate value 0x00
    adc  a, h           ; ROM0:000C - Add H plus carry to A
...
.org 0x000F
    ...
    adc  a, d           ; ROM0:0014 - Add D plus carry to A
...
.org 0x0017
    ...
    sub  b              ; ROM0:001B - Subtract B from A
    jr   0x0019         ; ROM0:001C - Jump to 0x0019
    ld   a, l           ; ROM0:001E - Load L into A
    rst  0x38           ; ROM0:001F - Call reset vector 0x38
    push af             ; ROM0:0020 - Push AF to stack
    di                  ; ROM0:0021 - Disable interrupts
    ldh  a, (0x41)      ; ROM0:0022 - Load LCD status register into A (was 0xFF41)
    and  a, 0x03        ; ROM0:0024 - Mask bits 0-1 (mode flags)
    jr   nz, 0x0022     ; ROM0:0026 - Jump to 0x0022 if not in VBlank/HBlank
    pop  af             ; ROM0:0028 - Pop AF from stack
    ld   (hl), a        ; ROM0:0029 - Load A into address HL
    ei                  ; ROM0:002A - Enable interrupts
    ret                 ; ROM0:002B - Return from subroutine
    rst  0x38           ; ROM0:002C - Call reset vector 0x38
    rst  0x38           ; ROM0:002D - Call reset vector 0x38
    rst  0x38           ; ROM0:002E - Call reset vector 0x38
    rst  0x38           ; ROM0:002F - Call reset vector 0x38
    ld   b, 0x00        ; ROM0:0030 - Load B with immediate value 0x00
    cp   c              ; ROM0:0032 - Compare A with C
    jr   c, 0x0039      ; ROM0:0033 - Jump to 0x0039 if carry set
    sub  c              ; ROM0:0035 - Subtract C from A
    inc  b              ; ROM0:0036 - Increment B
    jr   0x0032         ; ROM0:0037 - Jump to 0x0032
    ld   c, a           ; ROM0:0039 - Load A into C
    ret                 ; ROM0:003A - Return from subroutine
    rst  0x38           ; ROM0:003B - Call reset vector 0x38
    push af             ; ROM0:003C - Push AF to stack
    rst  0x30           ; ROM0:003D - Call reset vector 0x30
    rst  0x30           ; ROM0:003E - Call reset vector 0x30
    rst  0x38           ; ROM0:003F - Call reset vector 0x38
    jp   0x0519         ; ROM0:0040 - Jump to 0x0519
    inc  b              ; ROM0:0043 - Increment B
    nop                 ; ROM0:0044 - No operation
    and  d              ; ROM0:0045 - AND A with D
    cp   d              ; ROM0:0046 - Compare A with D
    add  a, d           ; ROM0:0047 - Add D to A
    jp   0x09CF         ; ROM0:0048 - Jump to 0x09CF
    rst  0x38           ; ROM0:004B - Call reset vector 0x38
    rst  0x38           ; ROM0:004C - Call reset vector 0x38
    rst  0x38           ; ROM0:004D - Call reset vector 0x38
    rst  0x38           ; ROM0:004E - Call reset vector 0x38
    cp   a              ; ROM0:004F - Compare A with itself
    jp   0x13F8         ; ROM0:0050 - Jump to 0x13F8
    call 0x0056         ; ROM0:0053 - Call subroutine at 0x0056
    db   0xCD, 0x59     ; ROM0:0056 - Raw bytes (call 0x5900 truncated)
    nop                 ; ROM0:0058 - No operation
    call 0x005C         ; ROM0:0059 - Call subroutine at 0x005C
    call 0x005F         ; ROM0:005C - Call subroutine at 0x005F
    db   0xCD           ; ROM0:005F - Raw byte (call truncated)
    ld   h, d           ; ROM0:0060 - Load D into H
    nop                 ; ROM0:0061 - No operation
    call 0x0065         ; ROM0:0062 - Call subroutine at 0x0065
    call 0x0068         ; ROM0:0065 - Call subroutine at 0x0068
    call 0x006B         ; ROM0:0068 - Call subroutine at 0x006B
    ldh  a, (0xB6)      ; ROM0:006B - Load value at 0xFFB6 into A (was 0xFFB6)
    and  a              ; ROM0:006D - Test A for zero
    jr   z, 0x006B      ; ROM0:006E - Jump to 0x006B if zero
    call 0x02C9         ; ROM0:0070 - Call subroutine at 0x02C9
    xor  a              ; ROM0:0073 - Clear A
    ldh  (0xB6), a      ; ROM0:0074 - Store A at 0xFFB6 (was 0xFFB6)
    ret                 ; ROM0:0076 - Return from subroutine
    xor  a              ; ROM0:0077 - Clear A
    ldh  (0xB6), a      ; ROM0:0078 - Store A at 0xFFB6 (was 0xFFB6)
    jr   0x006B         ; ROM0:007A - Jump to 0x006B
    ld   a, 0x0E        ; ROM0:007C - Load A with 0x0E
    jr   0x0082         ; ROM0:007E - Jump to 0x0082
    ld   a, 0x04        ; ROM0:0080 - Load A with 0x04
    ld   de, 0x008C     ; ROM0:0082 - Load DE with 0x008C
    push de             ; ROM0:0085 - Push DE to stack
    ldh  (0xC8), a      ; ROM0:0086 - Store A at 0xFFC8 (was 0xFFC8)
    ld   (0x3FFF), a    ; ROM0:0088 - Store A at 0x3FFF
    jp   hl             ; ROM0:008B - Jump to address in HL
    ldh  a, (0xC9)      ; ROM0:008C - Load value at 0xFFC9 into A (was 0xFFC9)
    ldh  (0xC8), a      ; ROM0:008E - Store A at 0xFFC8 (was 0xFFC8)
    ld   (0x3FFF), a    ; ROM0:0090 - Store A at 0x3FFF
    ret                 ; ROM0:0093 - Return from subroutine
    push hl             ; ROM0:0094 - Push HL to stack
    push bc             ; ROM0:0095 - Push BC to stack
    ldi  a, (hl)        ; ROM0:0096 - Load from HL to A, increment HL
    ld   (de), a        ; ROM0:0097 - Store A at DE
    inc  de             ; ROM0:0098 - Increment DE
    dec  b              ; ROM0:0099 - Decrement B
    jr   nz, 0x0096     ; ROM0:009A - Jump to 0x0096 if not zero
    pop  bc             ; ROM0:009C - Pop BC from stack
    pop  hl             ; ROM0:009D - Pop HL from stack
    dec  c              ; ROM0:009E - Decrement C
    jr   nz, 0x0094     ; ROM0:009F - Jump to 0x0094 if not zero
    ret                 ; ROM0:00A1 - Return from subroutine
    ldh  a, (0xCF)      ; ROM0:00A2 - Load value at 0xFFCF into A (was 0xFFCF)
    ld   d, a           ; ROM0:00A4 - Load A into D
    ldh  a, (0xCE)      ; ROM0:00A5 - Load value at 0xFFCE into A (was 0xFFCE)
    ld   e, a           ; ROM0:00A7 - Load A into E
    ld   b, 0x04        ; ROM0:00A8 - Load B with 0x04
    rr   d              ; ROM0:00AA - Rotate D right through carry
    rr   e              ; ROM0:00AC - Rotate E right through carry
    dec  b              ; ROM0:00AE - Decrement B
    jr   nz, 0x00AA     ; ROM0:00AF - Jump to 0x00AA if not zero
    ld   a, e           ; ROM0:00B1 - Load E into A
    and  a, 0xFE        ; ROM0:00B2 - Mask A with 0xFE
    sub  a, 0x80        ; ROM0:00B4 - Subtract 0x80 from A
    rlca                ; ROM0:00B6 - Rotate A left
    rlca                ; ROM0:00B7 - Rotate A left
    add  a, 0x10        ; ROM0:00B8 - Add 0x10 to A
    ldh  (0xCC), a      ; ROM0:00BA - Store A at 0xFFCC (was 0xFFCC)
    ldh  a, (0xCE)      ; ROM0:00BC - Load value at 0xFFCE into A (was 0xFFCE)
    and  a, 0x1F        ; ROM0:00BE - Mask A with 0x1F
    rla                 ; ROM0:00C0 - Rotate A left through carry
    rla                 ; ROM0:00C1 - Rotate A left through carry
    rla                 ; ROM0:00C2 - Rotate A left through carry
    add  a, 0x08        ; ROM0:00C3 - Add 0x08 to A
    ldh  (0xCD), a      ; ROM0:00C5 - Store A at 0xFFCD (was 0xFFCD)
    ret                 ; ROM0:00C7 - Return from subroutine
    push hl             ; ROM0:00C8 - Push HL to stack
    ld   hl, 0x7900     ; ROM0:00C9 - Load HL with 0x7900
    ld   e, a           ; ROM0:00CC - Load A into E
    ld   d, 0x00        ; ROM0:00CD - Load D with 0x00
    sla  e              ; ROM0:00CF - Shift E left
    rl   d              ; ROM0:00D1 - Rotate D left through carry
    sla  e              ; ROM0:00D3 - Shift E left
    rl   d              ; ROM0:00D5 - Rotate D left through carry
    sla  e              ; ROM0:00D7 - Shift E left
    rl   d              ; ROM0:00D9 - Rotate D left through carry
    add  hl, de         ; ROM0:00DB - Add DE to HL
    ld   e, l           ; ROM0:00DC - Load L into E
    ld   d, h           ; ROM0:00DD - Load H into D
    pop  hl             ; ROM0:00DE - Pop HL from stack
    ld   a, 0x0C        ; ROM0:00DF - Load A with 0x0C
    ldh  (0xC8), a      ; ROM0:00E1 - Store A at 0xFFC8 (was 0xFFC8)
    ld   (0x3FFF), a    ; ROM0:00E3 - Store A at 0x3FFF
    push bc             ; ROM0:00E6 - Push BC to stack
    ld   b, 0x08        ; ROM0:00E7 - Load B with 0x08
    ld   a, (de)        ; ROM0:00E9 - Load value at DE into A
    rst  0x20           ; ROM0:00EA - Call reset vector 0x20
    inc  hl             ; ROM0:00EB - Increment HL
    ld   a, (de)        ; ROM0:00EC - Load value at DE into A
    rst  0x20           ; ROM0:00ED - Call reset vector 0x20
    inc  de             ; ROM0:00EE - Increment DE
    inc  hl             ; ROM0:00EF - Increment HL
    dec  b              ; ROM0:00F0 - Decrement B
    jr   nz, 0x00E9     ; ROM0:00F1 - Jump to 0x00E9 if not zero
    pop  bc             ; ROM0:00F3 - Pop BC from stack
    dec  b              ; ROM0:00F4 - Decrement B
    jr   nz, 0x00E6     ; ROM0:00F5 - Jump to 0x00E6 if not zero
    ldh  a, (0xC9)      ; ROM0:00F7 - Load value at 0xFFC9 into A (was 0xFFC9)
    ldh  (0xC8), a      ; ROM0:00F9 - Store A at 0xFFC8 (was 0xFFC8)
    ld   (0x3FFF), a    ; ROM0:00FB - Store A at 0x3FFF
    ret                 ; ROM0:00FE - Return from subroutine
    rst  0x30           ; ROM0:00FF - Call reset vector 0x30
    nop                 ; ROM0:0100 - No operation
    jp   0x0150         ; ROM0:0101 - Jump to 0x0150
    db   0xCE, 0xED, 0x66, 0x66, 0xCC, 0x0D, 0x00, 0x0B, 0x03, 0x73, 0x00, 0x83, 0x00, 0x0C, 0x00, 0x0D ; ROM0:0104 - Raw data
    db   0x00, 0x08, 0x11, 0x1F, 0x88, 0x89, 0x00, 0x0E, 0xDC, 0xCC, 0x6E, 0xE6, 0xDD, 0xDD, 0xD9, 0x99 ; ROM0:0114 - Raw data
    db   0xBB, 0xBB, 0x67, 0x63, 0x6E, 0x0E, 0xEC, 0xCC, 0xDD, 0xDC, 0x99, 0x9F, 0xBB, 0xB9, 0x33, 0x3E ; ROM0:0124 - Raw data
...
db 0x0E, 0x0E, 0x1C, 0x1C, 0x18, 0x00, 0x30, 0x30  ; Tenten-kana (゛)
db 0x3C, 0x6E, 0x6E, 0x1C, 0x18, 0x00, 0x18, 0x18  ; Maruten-kana (゜)
